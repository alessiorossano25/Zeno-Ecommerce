				...
				<div class="card-header bg-white border-0">
					<div class=" fantasma row align-items-center">
						...
						<div class="pb-3 pt-3 text-right d-flex justify-content-end">
							<a href="/Ecommerce/ListaAcquisti" class="storico btn btn-sm btn-outline-primary"><i class="fa fa-first-order" aria-hidden="true"></i>
							Storico Ordini</a> 
							<a href="/Ecommerce/ControlloUtente" class="storico btn btn-sm btn-outline-success"><i class="fa fa-cart-plus" aria-hidden="true"></i>
							Inserisci prodotto</a>
							<a href="/Ecommerce/ListaProdottiAdmin" class="storico btn btn-sm btn-outline-danger"> <i class="fa fa-wrench" aria-hidden="true"></i>
							 Modifica / <i class="fa fa-trash" aria-hidden="true"></i> Elimina Prodotto</a> 
							<a href="/Ecommerce/ListaUtenti" class="storico btn btn-sm btn-outline-info"><i class="fa fa-address-card-o" aria-hidden="true"></i>
							 Lista Utenti</a>
							<a href="/Ecommerce/Carrello" class="storico btn btn-sm btn-outline-dark"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
							Torna al carrello</a>
						</div>
					</div>
				</div>
