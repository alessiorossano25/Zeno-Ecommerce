...
@WebServlet("/ControlloUtenteHome")
public class ControlloUtenteHomeServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (tu.getTipoUtente().equals("admin")) {
			req.getRequestDispatcher("/JSP/Privata/InfoAdmin.jsp").forward(req, resp);
		}
		else {
			req.getRequestDispatcher("/JSP/Privata/InfoUtente.jsp").forward(req, resp);
		}
	}
}
